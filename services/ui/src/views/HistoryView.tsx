    ...
    <div className="md:pl-16 flex flex-col flex-1 min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center sticky top-0 z-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 truncate max-w-2xl">{filename ? decodeURIComponent(filename) : ''}</p>
        </div>
      </header>
      ...
      <main className="p-8">
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg border-2 border-dashed border-gray-300">
            <p className="text-sm text-gray-500">No history found for this workflow.</p>
          </div>
        ) : (
                  ...
                  <div className="relative pb-8">
                    ...
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-900 font-semibold">{commit.title}</p>
                          ...
                          {commit.message !== commit.title && (
                            <p className="mt-2 text-sm text-gray-600 whitespace-pre-wrap">{commit.message}</p>
                          )}
                        </div>
                        <div className="text-right text-xs whitespace-nowrap text-gray-500">
                          <code className="bg-gray-100 px-1 py-0.5 rounded">{commit.short_id}</code>
                        </div>
                      </div>
                    </div>
                  </div>
